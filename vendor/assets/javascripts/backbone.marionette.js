...
define(['ba-debug', 'jquery-adapter', 'underscore', 'backbone', 'handlebars'], function(console, $, _, Backbone, Handlebars) {
  console.log('Backbone loaded version', Backbone.VERSION);
  console.log('Handlebars loaded version', Handlebars.VERSION);
...
//    }
//  });
//  Handlebars.registerHelper("ifGt", function(value, requirement, options){
...
//    return null;
//  });
//  Handlebars.registerHelper("bindAttrIf", function(tester, requirement, value){
//    if(tester == requirement){
//      return value + "=\"" + value + "\"";
//    }
//    return null;
//  });
//  Handlebars.registerHelper("nTimesDo", function(howManyTimes, fn){
//    var html = "";
...
//      result = result + Handlebars.Utils.escapeExpression(lines[i]);
//      if(i < lines.length - 1) result = result + "<br/>";
//    }
//    return new Handlebars.SafeString(result);
//  });
//
//  Handlebars.registerHelper("add", function(base, change){
//    return new Handlebars.SafeString(base + change);
//  });
//
//  Handlebars.registerHelper("sub", function(base, change){
//    return new Handlebars.SafeString(base - change);
//  });
  ...
  console.log('Backbone.BabySitter loaded')
  ...
  console.log('Backbone.Wreqr loaded')
  ...
  console.log('Backbone.Marionette loaded')
